...
# Bayesian Inference ----  
  ...
  m <- read.jagsfile("BayesModel/model_CJS_R_ver2.R")
...
# Output ----
  ...
  file1 <- paste0("Result/re_modelCJS_R_ver2_", Sys.Date(), ".csv")
...
# WAIC ----
  ...
  WAIC <- waic(loglik)
  file2 <- paste0("Result/WAIC_modelCJS_R_ver2_", Sys.Date(), ".csv")
